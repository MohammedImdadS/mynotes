...
import 'package:mdapp/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request. Please make sue that you are a register user, or if not, register a user now by going back one step.');
          }
        }
      },
      child: Scaffold(
