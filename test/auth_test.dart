...
void main() {
  group('Mock Authentication', () {
    ...
    test('Should be able be log out and log in again', () async {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> login({
    ...
    const user = AuthUser(isEmailVerified: false, email: 'i@i.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'i@i.com');
    _user = newUser;
  }
}
